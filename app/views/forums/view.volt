              ...
              <div class="metadata">
                <div class="date">
                  ...
                  {% if post.origin() %}
                    ...
                    {% elseif post.origin() == 'dweebs' %}
                    <a href="http://dweebs.io/">dWeebs</a>
                    {% else %}
                      Unknown - [{{ post.origin() }}]
                    {% endif %}
                    )
                ...
                <div class="actions">
                  ...
                  <a href="https://dsite.io{{ post.url }}" target="_blank">dSite</a>
                  <a href="https://bex.network/tag/@{{ post.author }}/{{ post.permlink }}" target="_blank">dPay Explorer</strong>.com</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="ten wide column">
        ...
        <div class='dpayid reply'>
          <form class='ui reply form' action='http://dpayid.io/sign/comment' method='get' target='iframe'>
            ...
            <input type="hidden" name='json_metadata' value='{"app": "dpayexplorer/0.1", "format": "markdown"}'>
    ...
    <div class="ui notice modal">
      ...
      <div class="content">
        <div class="ui padded basic segment" style="font: 16px">
          <p>
            Before you continue, please take a moment to understand how leaving a response on DPayExplorer works.
          </p>
          <p>
            The signing of these transactions uses tools provided by <a href="https://dpayid.com/" target="_blank">dPayID.io</a>. DPayExplorer is embedding and using these tools to allow your actions to take place.
          </p>
          <p>
            <strong>For security reasons, we recommend you use your "posting" key to keep your account safe.</strong>
          </p>
          <p>
            Once you create a post or reply, it may take up to 1 minute to appear here on DPayExplorer.
          </p>
        </div>
        <div class="actions">
...
$( document ).ready(function() {
  ...
  $("a.reply[data-permlink][data-author]").on('click', function() {
    var permlink = $(this).attr("data-permlink"),
        ...
        json_metadata = $("<input type='hidden' name='json_metadata' value='{\"app\": \"dpayexplorer/0.1\", \"format\": \"markdown\"}'>"),
